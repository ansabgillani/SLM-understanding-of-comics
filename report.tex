...
\begin{enumerate}
    \item \textbf{Layer 1 (Tagging/Augmentation):} Basic classification of genre or style.
    \item \textbf{Layer 2 (Grounding):} Detection of panels, characters, and text.
    \item \textbf{Layer 3 (Retrieval):} Finding specific panels based on semantic queries.
    \item \textbf{Layer 4 (Understanding):} VQA and visual closure.
    \item \textbf{Layer 5 (Generation):} Creating new panels or dialogue.
\end{enumerate}
